   ...
   if (isset($_POST["submit"])) {
      ...
      if (strlen($new_password) < 6) {
       ...
       ';
         ...
         $updating_profile = mysqli_query($connect, "UPDATE `doctor` SET `firstname`='$new_firstname',`lastname`='$new_lastname',`othername`='$new_othername',`email`='$new_email',`password`='$new_password',`blood_group`='$new_bloodgroup',`genotype`='$new_genotype' WHERE doctor_id = $user_id");
